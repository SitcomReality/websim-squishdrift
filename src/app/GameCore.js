...
export class Game {
  ...
  update(dt) {
    ...
    this.debugOverlay.update({
      ...
      vehicle: s.control.vehicle ? { at: s.control.vehicle.node ? [s.control.vehicle.node.x, s.control.vehicle.node.y] : [s.control.vehicle.pos.x, s.control.vehicle.pos.y], speed: Number((s.control.vehicle.speed||0).toFixed(2)) } : null,
