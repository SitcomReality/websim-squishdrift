...
src/app/core/systems/RenderSystem.js
```
import { Vec2 } from '../../../utils/Vec2.js';
import { drawTiles } from '../../../render/drawTiles.js';
import { drawBuildings } from '../../entities/drawBuildings.js';
...
src/app/core/systems/particles/emitters/DriftEmitter.js
```
import { Vec2 } from '../../../utils/Vec2.js';
import { drawParticle } from '../../entities/drawParticle.js';
...
Here is the updated code for src/app/core/systems/LightingSystem.js. Do not wrap it in <current-code> tags, wrap it in ```. If something conflicts between current code and the plan (e.g. function signature), prefer the plan's version. 
