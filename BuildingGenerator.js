export class BuildingGenerator {
  ...
  createBuilding(tiles, buildingRect, isOctagon = false) {
    const building = {
      rect: buildingRect,
    ...
    for (let ly = 0; ly < buildingRect.height; ly++) {
      for (let lx = 0; lx < buildingRect.width; lx++) {
